...
namespace SIMS.BL
{
    ...
    public class MaterialMovement
    {
        ...
        static string connectionString = "Server=DESKTOP-S0SK0I6\\SQLEXPRESS;Database=shlokaa;Integrated Security=SSPI;";
        #region Fields
        private int _id;
        ...
        // ,string invoiceno, DateTime? invoicedate, string invoiceamount,
        public MaterialMovement(int id, DateTime timestamp, int staffid, int customerid, int itemid, string size, int unitId,string unitName, string quantity, string remarks, string movementtype, bool isdeleted, string UserName, string ItemName, string CustomerName, string UserType)
        {
            _id = id;
        ...
        #region CRUD
        //, string Invoiceno, DateTime? Invoicedate, string Invoiceamount
        public static int Create(DateTime Timestamp, int Staffid, int Customerid, int Itemid, int UnitId, string Quantity, string Remarks, string Movementtype, bool Isdeleted)
        {
            try
            {
                string sqlStatement;
                ...
                {
                    //Invoiceno, Invoicedate,Invoiceamount, @Invoiceno, @Invoicedate,@Invoiceamount,
                    SqlCommand manageCommand;
                    sqlStatement = "Insert MaterialMovement ( Timestamp, Staffid, Customerid, Itemid,  UnitId, Quantity,  Remarks, Movementtype, IsDeleted ) "
                        + " values ( @Timestamp, @Staffid, @Customerid, @Itemid, @UnitId, @Quantity,  @Remarks, @Movementtype, @IsDeleted)";
